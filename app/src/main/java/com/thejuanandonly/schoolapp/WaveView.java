...
/**
 * Created by Daniel on 19-Mar-17.
 */
...
public class WaveView extends LinearLayout {
    ...
    private final int DEFAULT_ABOVE_WAVE_COLOR = Color.parseColor("#e74c3c");
    private final int DEFAULT_BLOW_WAVE_COLOR = Color.parseColor("#e74c3c");
    ...
    public WaveView(Context context, AttributeSet attrs) {
        ...
        maxProgress = attributes.getInt(R.styleable.WaveView_max_progress, (int)maxProgress);
    ...
    public void setProgress(int progress) {
        this.mProgress = progress > (int) maxProgress ? (int) maxProgress : progress;
        computeWaveToTop();
    }
    ...
    private void computeWaveToTop() {
        mWaveToTop = (int) (getHeight() * (1f - mProgress / maxProgress));
